...
\DoxyCodeLine{\ \ \ \ \};}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{class\ }udp\_socket\_descriptor\ :\ \textcolor{keyword}{public}\ udp\_socket\_descriptor}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{public}:}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{classwebcraft_1_1async_1_1task}{task<size\_t>}}\ recvfrom(std::span<char>\ buffer,\ connection\_info\&\ from\_address);\ \textcolor{comment}{//\ receives\ a\ packet\ from\ some\ address\ (which\ is\ populated)}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{classwebcraft_1_1async_1_1task}{task<size\_t>}}\ sendto(std::span<const\ char>\ buffer,\ \textcolor{keyword}{const}\ connection\_info\&\ to\_address);\ \textcolor{comment}{//\ sends\ a\ packet\ to\ some\ address\ (which\ is\ provided)}}
\DoxyCodeLine{\ \ \ \ \};}
\DoxyCodeLine{}
